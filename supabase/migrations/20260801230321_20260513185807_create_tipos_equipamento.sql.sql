/*
  ...
  1. New Tables - `tipos_equipamento` (equipment type catalog)
  2. Security - RLS enabled, authenticated CRUD
  3. Seed Data - Pre-populate with default types
*/
